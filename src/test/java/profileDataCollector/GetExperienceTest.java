...
public class GetExperienceTest {
    ...
    public void testGetExperience() {
        ...
        Assert.assertEquals(new GetExperience().getData(sampleText1), "4.5");

        String sampleText2 = "Work Experience : 5+ years";
        Assert.assertEquals(new GetExperience().getData(sampleText2), "5");

        String sampleText3 = "Experience on Selenium & Appium";
        Assert.assertEquals(new GetExperience().getData(sampleText3), "Experience years not mentioned");
    }
}